                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <span class="btn btn-sm btn-info"> Daftar Penilaian</span>
                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a class="btn btn-sm btn-primary" href="<?= base_url('guru/nilai/'. $row['id_tugas']. '/' . $row['id_kelas']); ?>">Check</a>
                                        <a class="btn btn-sm btn-success" href="<?= base_url('guru/rekap_nilai_kelas/'. $row['id_tugas']. '/' . $row['id_kelas']); ?>">Cetak</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
